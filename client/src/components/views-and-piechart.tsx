...
export default function MobileAndDesktopPieChart() {
  const [view, setView] = useState<string>("Integrated");
    ...
    <Card className="@container/card h-full">
      <CardHeader>
        ...
        >
          ...
          <ToggleGroupItem value="Integrated">Integrated</ToggleGroupItem>
        </ToggleGroup>
        ...
        <Select value={view} onValueChange={setView}>
          ...
          <SelectContent className="rounded-xl">
            ...
            <SelectItem value="Integrated" className="rounded-lg">
              Integrated
            </SelectItem>
          </SelectContent>
        </Select>
          ...
          <PieChart>
            ...
            >
              {pieData.map((entry, index) => {
                const isSelected = view === "Integrated" || view === entry.key;
                return (
                  <Cell
                    key={`cell-${index}`}
